...
#
# genesys2_basic.tcl: Tcl script for re-creating project 'genesys2_basic'
#
# Generated by Vivado on Mon Jan 27 13:55:13 +0100 2025
...
#
# 1. This project restoration tcl script (genesys2_basic.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/amd_work/genesys2/proj5/genesys_2_2024_1-main/archive_project_summary.txt"
#    "C:/amd_work/genesys2/proj5/genesys_2_2024_1-main/genesys2_basic.srcs/sources_1/bd/system/ip/system_mig_7series_0_0/board.prj"
#    "C:/amd_work/genesys2/proj5/genesys_2_2024_1-main/genesys2_basic.srcs/sources_1/bd/system/ip/system_mig_7series_0_0/mig_a.prj"
#    "C:/amd_work/genesys2/proj5/genesys_2_2024_1-main/genesys2_basic.srcs/sources_1/bd/system/ip/system_mig_7series_0_0/mig_b.prj"
#    "C:/amd_work/genesys2/proj5/genesys_2_2024_1-main/genesys2_basic.srcs/constrs_1/imports/Downloads/Genesys-2-Master.xdc"
#    "C:/amd_work/genesys2/proj5/genesys_2_2024_1-main/genesys2_basic.srcs/utils_1/imports/synth_1/system_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/genesys2_basic.srcs/sources_1/bd/system/ip/system_mig_7series_0_0/board.prj"]"\
 "[file normalize "$origin_dir/genesys2_basic.srcs/sources_1/bd/system/ip/system_mig_7series_0_0/mig_a.prj"]"\
 "[file normalize "$origin_dir/genesys2_basic.srcs/sources_1/bd/system/ip/system_mig_7series_0_0/mig_b.prj"]"\
 "[file normalize "$origin_dir/genesys2_basic.srcs/constrs_1/imports/Downloads/Genesys-2-Master.xdc"]"\
 "[file normalize "$origin_dir/genesys2_basic.srcs/utils_1/imports/synth_1/system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "genesys2_basic"
...
set script_file "genesys2_basic.tcl"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/genesys2_basic.board"]" -objects $obj
...
set file "genesys_2_2024_1-main/archive_project_summary.txt"
...
set file "system_mig_7series_0_0/mig_b.prj"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set file "[file normalize ${origin_dir}/genesys2_basic.srcs/constrs_1/imports/Downloads/Genesys-2-Master.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "Downloads/Genesys-2-Master.xdc"
...
set_property -name "target_constrs_file" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/Downloads/Genesys-2-Master.xdc" -objects $obj
set_property -name "target_ucf" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/Downloads/Genesys-2-Master.xdc" -objects $obj
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  set BTN [ create_bd_port -dir I -from 0 -to 4 BTN ]
  ...
  set_property -dict [list \
    ...
    CONFIG.C_LMB_PROTOCOL {0} \
    CONFIG.C_MB_DBG_PORTS {1} \
    CONFIG.C_M_AXIS_DATA_WIDTH {32} \
    CONFIG.C_M_AXIS_ID_WIDTH {7} \
    CONFIG.C_M_AXI_ADDR_WIDTH {32} \
    CONFIG.C_M_AXI_DATA_WIDTH {32} \
    CONFIG.C_M_AXI_THREAD_ID_WIDTH {1} \
  ...
  set_property CONFIG.C_HAS_FAST {0} $axi_intc_0
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI] [get_bd_intf_pins axi_intc_0/s_axi]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_ports LED]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M04_ACLK]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_mb_reset [get_bd_pins rst_mig_7series_0_100M/mb_reset] [get_bd_pins microblaze_0/Reset]
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN]
...
if { [get_property IS_LOCKED [ get_files -norecurse [list system.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/genesys2_basic.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
